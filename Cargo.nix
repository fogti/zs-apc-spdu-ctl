  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "handleapi" "windef" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      ...
      "zs-apc-spdu-ctl" = rec {
        crateName = "zs-apc-spdu-ctl";
        version = "0.0.3";
        edition = "2018";
        crateBin = [
          { name = "zs-apc-spdu-ctl"; path = "src/main.rs"; }
        ];
